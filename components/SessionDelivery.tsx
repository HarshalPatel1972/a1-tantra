...
export default function SessionDelivery() {
  return (
    <section className="py-16 bg-[#3F2F27] text-cream relative overflow-hidden border-t border-b border-soft-gold/20">
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-10 relative z-10">
        <div className="bg-[#1C1614]/80 backdrop-blur-md border border-soft-gold/30 p-8 sm:p-12 rounded-3xl shadow-2xl relative">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="space-y-6 text-center md:text-left flex-grow">
              ...
              <div className="w-16 h-0.5 bg-[#E44426] mx-auto md:mx-0 rounded-full"></div>
              
              <p className="font-body text-base sm:text-lg text-cream/90 font-black leading-relaxed">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left font-body text-sm font-semibold max-w-lg mx-auto md:mx-0 text-cream/90">
                <li className="flex items-center gap-2">
                  <span className="text-[#D4AF37]">✔</span> Date & Availability
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#D4AF37]">✔</span> Preferred Location/City
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#D4AF37]">✔</span> Travel Arrangements
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#D4AF37]">✔</span> Session Scheduling
                </li>
              </ul>
            </div>
          </div>
