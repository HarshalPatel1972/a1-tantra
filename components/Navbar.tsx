          ...
          {isAuthenticated ? (
            <div className="flex gap-4 items-center">
              ...
              <Link
                ...
                className="group relative flex items-center justify-center w-10 h-10 rounded-full text-[#25D366] hover:bg-[#25D366]/5 transition-all duration-300 border border-transparent hover:border-[#25D366]/20"
                title="Chat with us"
              >
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-[#25D366] rounded-full border-2 border-white animate-pulse z-20"></div>
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
                  viewBox="0 0 448 512"
