      ...
      <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 bg-white/10 hover:bg-white/15 focus:bg-white border-2 border-white/20 focus:border-[#E44426] rounded-xl focus:outline-none font-body text-sm font-bold text-white focus:text-[#3F2F27] focus:placeholder-[#3F2F27]/40 placeholder:text-white/40 transition-all"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="w-full pl-16 pr-4 py-3 bg-white/10 hover:bg-white/15 focus:bg-white border-2 border-white/20 focus:border-[#E44426] rounded-xl focus:outline-none font-body text-sm font-bold text-white focus:text-[#3F2F27] focus:placeholder-[#3F2F27]/40 placeholder:text-white/40 transition-all"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              value={formData.goal}
              onChange={handleChange}
              className="w-full px-4 py-3 pr-10 bg-white/10 hover:bg-white/15 focus:bg-white border-2 border-white/20 focus:border-[#E44426] rounded-xl focus:outline-none font-body text-sm font-bold text-white focus:text-[#3F2F27] appearance-none cursor-pointer transition-all"
            >
              {goals.map((g) => (
