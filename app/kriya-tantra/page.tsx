              ...
              >
                ...
                >
                  ...
                  <span className="flex items-center gap-2">
                    <span className="line-through text-xs font-bold" style={{ color: "rgba(255,235,225,0.35)" }}>₹70,000</span>
                    <span className="text-base font-black" style={{ color: "#FF7A5A" }}>₹50,000</span>
                    <span
