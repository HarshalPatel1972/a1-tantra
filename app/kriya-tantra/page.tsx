    ...
    <div className="bg-cream min-h-screen">
              ...
              <div className="bg-white/40 border border-deep-brown/5 rounded-2xl p-5 max-w-lg space-y-3 font-body text-sm font-semibold text-deep-brown/85">
                ...
                <div className="flex justify-between border-b border-deep-brown/5 pb-2">
                  ...
                  <span className="flex items-center gap-2">
                    <span className="line-through text-deep-brown/40 text-xs font-bold">₹35,000</span>
                    <span className="text-[#E44426] text-base font-black">₹25,000</span>
                    <span className="text-[10px] bg-[#E44426]/10 border border-[#E44426]/20 px-1.5 py-0.5 rounded text-[#E44426] font-black">30% OFF</span>
                  </span>
                </div>
      ...
      <section className="py-16 bg-brand-blue text-cream text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <p className="font-body text-base text-cream/85 mb-8 max-w-xl mx-auto">Get in touch today to secure the special offer price of ₹25,000 (limited time offer) and coordinate in-person availability for Kriya Tantra.</p>
