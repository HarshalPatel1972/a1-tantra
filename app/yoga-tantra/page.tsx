              ...
              >
                ...
                >
                  ...
                  <span className="flex items-center gap-2">
                    <span className="line-through text-xs font-bold" style={{ color: "rgba(220,235,255,0.35)" }}>₹1,20,000</span>
                    <span className="text-base font-black" style={{ color: "#80B8FF" }}>₹80,000</span>
                    <span
